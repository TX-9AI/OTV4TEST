...
| `strategy/base_strategy.py` | 18 | atp_butterfly.py, check_credit_remainder.py, check_entry_gate.py, check_entry_underwater.py |
...
- **calls:** `config.py`, `execution/exit_engine.py`, `execution/position_manager.py`, `strategy/volt_plan.py`, `strategy/volt_strategy.py`
- **called by:** (nothing — no importer and no mention in any script, unit or doc here)
