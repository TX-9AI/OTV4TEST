...
|---|---|---|
| `config.py` | 89 | alert_manager.py, anchors.py, atp_butterfly.py, atp_butterfly_plan.py |
| `strategy/__init__.py` | 48 | atp_butterfly_plan.py, breakout_plan.py, check_age_gate_gone.py, check_anchors.py |
| `strategy/plan.py` | 44 | atp_butterfly_plan.py, breakout_plan.py, check_anchors.py, check_atp_butterfly.py |
| `utils/time_utils.py` | 39 | alert_manager.py, broker_reconcile.py, check_bfly_vwap_band.py, check_butterfly_foundational.py |
| `data/derived_store.py` | 25 | anchors.py, breakout_plan.py, check_bfly_vwap_band.py, check_derived_layer.py |
...
| `strategy/base_strategy.py` | 19 | atp_butterfly.py, breakout_plan.py, check_credit_remainder.py, check_entry_gate.py |
| `strategy/sweep_credit_spread.py` | 19 | check_age_gate_gone.py, check_atr_units.py, check_chain_ordering.py, check_dispatch.py |
| `execution/exit_engine.py` | 18 | check_condor_mgmt.py, check_condor_spec.py, check_condor_stop_suppression.py, check_exit_executes.py |
...
- **calls:** (none)
- **called by:** `derived/counterfactual.py`, `derived/notes.py`, `derived/snapshot.py`, `strategy/breakout_plan.py`
...
- **called by:** `main.py`, `shadow/observer.py`, `tests/check_indicator_votes.py`
...
- **calls:** (none)
- **called by:** `analysis/gate_report.py`, `derived/anchors.py`, `derived/gamma_regime.py`, `derived/registry.py`, `execution/exit_engine.py`, `strategy/breakout_plan.py`, `strategy/liquidity_hunt.py`, `strategy/plan.py`, `strategy/sweep_plan.py`, `strategy/tcs_plan.py`, `tests/check_bfly_vwap_band.py`, `tests/check_derived_layer.py`, `tests/check_engine_status.py`, `tests/check_indicator_votes.py`, `tests/check_level_map.py`, `tests/check_level_rejection.py`, `tests/check_level_source.py`, `tests/check_liquidity_hunt.py`, `tests/check_plan_heartbeat.py`, `tests/check_plan_prepares.py`, `tests/check_runaway_plan.py`, `tests/check_sweep_excursion.py`, `tests/check_tcs_narrates.py`, `tests/check_tcs_plan.py`, `tests/check_zones.py`
...
- **called by:** `derived/levels.py`, `main.py`, `tests/check_level_map.py`, `tests/check_level_tape.py`, `tests/check_zones.py`

### `derived/levels.py`
- **calls:** `config.py`, `derived/__init__.py`, `derived/base.py`, `derived/level_map.py`, `derived/registry.py`
- **called by:** `derived/registry.py`, `execution/exit_engine.py`, `strategy/breakout_plan.py`, `strategy/liquidity_hunt.py`, `strategy/sweep_plan.py`, `strategy/tcs_plan.py`, `tests/check_level_map.py`, `tests/check_level_rejection.py`, `tests/check_level_source.py`, `tests/check_sweep_excursion.py`, `tests/check_zones.py`
...
### `derived/snapshot.py`
- **calls:** `analysis/order_flow.py`, `derived/base.py`, `derived/gamma_regime.py`, `strategy/gex_pin_butterfly.py`
...
- **called by:** `analysis/entry_snapshot.py`, `execution/position_manager.py`, `strategy/condor_roll.py`, `strategy/management.py`, `tests/check_condor_mgmt.py`, `tests/check_condor_spec.py`, `tests/check_condor_stop_suppression.py`, `tests/check_exit_executes.py`, `tests/check_ladder_wired.py`, `tests/check_liquidity_hunt.py`, `tests/check_management_plan.py`, `tests/check_orb_plan.py`, `tests/check_runaway_plan.py`, `tests/check_sweep_plan.py`, `tests/check_tcs_plan.py`, `tests/check_volt_plan.py`, `tests/stress_entry_path.py`, `tools/stress_theta_bleed.py`
...
- **called by:** `tests/check_admission_wired.py`, `tests/check_atm_iv_stored.py`, `tests/check_atp_butterfly.py`, `tests/check_credit_remainder.py`, `tests/check_entry_underwater.py`, `tests/check_rehearsal_toggle.py`, `tests/check_signal_numeric_tail.py`, `tests/check_sweep_stop.py`, `tests/stress_entry_path.py`
...
- **calls:** `analysis/order_flow.py`, `config.py`, `data/derived_store.py`, `derived/gamma_regime.py`, `derived/levels.py`, `strategy/__init__.py`, `strategy/base_strategy.py`, `strategy/breakout.py`, `strategy/orb_plan.py`, `strategy/plan.py`
- **called by:** `strategy/breakout.py`, `tests/check_breakout.py`, `tests/check_breakout_research.py`, `tests/check_lazy_imports.py`
...
- **called by:** `strategy/breakout_plan.py`, `strategy/orb_strategy.py`, `tests/check_orb_plan.py`
...
- **called by:** `analysis/gate_report.py`, `derived/notes.py`, `derived/plans.py`, `main.py`, `strategy/atp_butterfly_plan.py`, `strategy/breakout_plan.py`, `strategy/condor_roll.py`, `strategy/gex_pin_butterfly.py`, `strategy/iron_condor_strategy.py`, `strategy/liquidity_hunt.py`, `strategy/management.py`, `strategy/orb_plan.py`, `strategy/runaway_plan.py`, `strategy/sweep_plan.py`, `strategy/tcs_plan.py`, `strategy/volt_plan.py`, `tests/check_anchors.py`, `tests/check_atp_butterfly.py`, `tests/check_bfly_vwap_band.py`, `tests/check_butterfly_foundational.py`, `tests/check_butterfly_legs.py`, `tests/check_butterfly_wing_grid.py`, `tests/check_chain_ordering.py`, `tests/check_condor_mgmt.py`, `tests/check_credit_window.py`, `tests/check_inactive_once.py`, `tests/check_liquidity_hunt.py`, `tests/check_management_plan.py`, `tests/check_not_asked_reasons.py`, `tests/check_note_label.py`, `tests/check_orb_plan.py`, `tests/check_orb_sequence.py`, `tests/check_plan_heartbeat.py`, `tests/check_plan_prepares.py`, `tests/check_plan_signal.py`, `tests/check_plan_status.py`, `tests/check_plan_wiring.py`, `tests/check_runaway_handoff.py`, `tests/check_runaway_plan.py`, `tests/check_signal_numeric_tail.py`, `tests/check_tcs_narrates.py`, `tests/check_tcs_plan.py`, `tests/check_tick_join.py`, `tests/check_wing_search.py`
...
- **called by:** `main.py`, `strategy/trend_credit_spread.py`, `tests/check_credit_window.py`, `tests/check_tcs_narrates.py`, `tests/check_tcs_plan.py`
...
- **called by:** `strategy/volt_strategy.py`, `tests/check_volt_plan.py`

### `strategy/volt_strategy.py`
- **calls:** `config.py`, `strategy/base_strategy.py`, `strategy/volt_plan.py`
- **called by:** `main.py`, `tests/check_volt_plan.py`
...
### `tests/check_admission.py`
- **calls:** `config.py`, `execution/position_manager.py`
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`

### `tests/check_admission_wired.py`
- **calls:** `execution/__init__.py`, `execution/position_manager.py`, `main.py`
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`
...
### `tests/check_entry_underwater.py`
- **calls:** `main.py`, `strategy/base_strategy.py`
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`
...
- **calls:** (none)
- **called by:** (not imported) — referenced in `devtools.sh`, `docs/BACKLOG.md`, `docs/PORT_STATE.md`, `docs/TRADES.md` +1
...
### `tests/check_land_spec_parse.py`
- **calls:** (none)
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`
...
### `tests/check_lazy_imports.py`
- **calls:** `strategy/__init__.py`, `strategy/breakout_plan.py`
- **called by:** (not imported) — referenced in `docs/BACKLOG.md`
...
### `tests/edge_scan.py`
- **calls:** (none)
- **called by:** (not imported) — referenced in `devtools.sh`, `docs/BACKLOG.md`, `docs/WORKING_AGREEMENT.md`
...
- **calls:** (none)
- **called by:** `main.py`, `tests/check_shutdown_cause.py`, `warehouse/midnight_halt.py`
