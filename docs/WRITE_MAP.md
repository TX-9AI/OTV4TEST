...
| `level_ledger` | `data/derived_store.py` | `data/derived_store.py` (insert/update) | `derived/anchors.py`, `derived/levels.py`, `tests/check_level_map.py`, `tests/check_level_rejection.py` |
