...
| `indicator_series` | `data/derived_store.py` | `data/derived_store.py` (insert), `tests/check_purge_reclaim.py` (insert), `warehouse/retention_purge.py` (delete) | `derived/anchors.py`, `tests/check_indicator_votes.py`, `warehouse/s3_push.py` |
...
| `plan_check` | `strategy/plan.py` | `strategy/plan.py` (insert), `tests/check_purge_reclaim.py` (insert), `warehouse/retention_purge.py` (delete) | `strategy/sweep_credit_spread.py`, `tests/check_bfly_vwap_band.py`, `tests/check_chain_ordering.py`, `tests/check_plan_prepares.py`, `tests/check_plan_wiring.py`, `tests/check_tick_join.py`, `warehouse/s3_push.py` |
...
| `quote_series` | `data/candle_feed.py` | `data/candle_feed.py` (insert), `tests/check_purge_reclaim.py` (insert), `tests/exit_replay.py` (insert), `warehouse/retention_purge.py` (delete) | `analysis/order_flow.py`, `tests/check_manifold_board.py`, `tools/manifold_health.py`, `tools/manifold_status.py`, `warehouse/s3_push.py` |
...
| `trades` | `database/trade_logger.py`, `tests/check_condor_stop_suppression.py` | `database/trade_logger.py` (insert/update), `tests/check_atp_butterfly.py` (insert), `tests/check_condor_pairing.py` (insert), `tests/check_dashboards_multi_position.py` (insert), `tests/check_management_plan.py` (insert), `tests/check_one_per_session.py` (insert), `tests/check_orb_geometry.py` (insert), `tests/check_plan_prepares.py` (insert), `tests/check_runaway_break_key.py` (insert), `tests/check_runaway_plan.py` (insert), `tests/check_structure_viable.py` (insert), `tests/check_sweep_plan.py` (insert) | `derived/counterfactual.py`, `main.py`, `notifications/alert_manager.py`, `query.py`, `status.py`, `strategy/runaway_continuation.py`, `strategy/runaway_plan.py`, `strategy/sweep_credit_spread.py`, `tests/edge_scan.py`, `tests/entry_profile.py`, `tests/eod_compare.py`, `tests/exit_record.py`, `tests/exit_replay.py`, `tests/orb_bleed_study.py`, `tests/r_ledger.py`, `tests/rejection_ledger.py`, `tests/stop_sweep.py`, `tools/eod_summary.py`, `warehouse/s3_push.py` |
