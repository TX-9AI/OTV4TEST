...
| `indicator_series` | `data/derived_store.py` | `data/derived_store.py` (insert), `tests/check_purge_reclaim.py` (insert), `warehouse/retention_purge.py` (delete) | `derived/anchors.py`, `warehouse/s3_push.py` |
